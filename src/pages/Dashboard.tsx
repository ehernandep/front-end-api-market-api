...
import { ArrowUp, Users, Database, ArrowRight } from "lucide-react";
...
const Dashboard = ({dashboardMetrics, apis}) => {
  const {formatNumber} = useDashboard();
  return (
    <div className="space-y-6 animate-fade-in">
      {dashboardMetrics && dashboardMetrics.totalApis ? (
        <>
                  ...
                  <CardContent className="space-y-2">
                    ...
                    <div className="pt-2 flex items-center justify-between text-xs text-muted-foreground">
                      <div className="flex items-center gap-1">
                        ...
                        <span>{formatNumber(api.stats.total_calls)} llamadas</span>
                      </div>
                      <div>
